...
function OrderCom({ closeHandler, product }) {
  ...
  return (
    ...
    >
      ...
      {paymentMethod ? (
        <div className="w-full px-[30px] py-10 border-primary-border-secondary  rounded-[5px]">
          ...
          <div className="grid lg:grid-cols-6 grid-cols-3 gap-[13px]">
            ...
            {/* paypal  */}
            {Number(paymentInfo?.data?.paypal?.status) === 1 && (
              <a
                href={
              ...
              >
                <img
                  src={process.env.BASE_URL + paymentInfo?.data?.paypal?.image}
                  alt=""
                  className="w-full h-full object-contain"
                />
              </a>
            ...
            {/* stripe  */}
            {Number(paymentInfo?.data?.stripe?.status) === 1 && (
              <a
                href={
                  process.env.BASE_URL +
              ...
              >
                <img
                  src={process.env.BASE_URL + paymentInfo?.data?.stripe?.image}
                  alt=""
                  className="w-full h-full object-contain"
                />
              </a>
            ...
            {/* razorpay  */}
            {Number(paymentInfo?.data?.razorpay?.status) === 1 && (
              <a
                href={
                  process.env.BASE_URL +
              ...
              >
                <img
                  src={
                    process.env.BASE_URL + paymentInfo?.data?.razorpay?.image
                  }
                  alt=""
                  className="w-full h-full object-contain"
                />
            ...
            {/* paystack  */}
            {Number(paymentInfo?.data?.paystack?.paystack_status) === 1 && (
              <a
                href={
                  process.env.BASE_URL +
              ...
              >
                <img
                  src={
                    process.env.BASE_URL +
                    paymentInfo?.data?.paystack?.paystack_image
                  }
                  alt=""
                  className="w-full h-full object-contain"
                />
            ...
            {/* mollie  */}
            {Number(paymentInfo?.data?.mollie?.mollie_status) === 1 && (
              <a
                href={
                  process.env.BASE_URL +
              ...
              >
                <img
                  src={
                    process.env.BASE_URL +
                    paymentInfo?.data?.mollie?.mollie_image
                  }
                  alt=""
                  className="w-full h-full object-contain"
                />
            ...
            {/* instamojo  */}
            {Number(paymentInfo?.data?.instamojo?.status) === 1 && (
              <a
                href={
                  process.env.BASE_URL +
              ...
              >
                <img
                  src={
                    process.env.BASE_URL + paymentInfo?.data?.instamojo?.image
                  }
                  alt=""
                  className="w-full h-full object-contain"
                />
            ...
            {/* flutterwave  */}
            {Number(paymentInfo?.data?.flutterwave?.status) === 1 && (
              <a
                href={
                  process.env.BASE_URL +
              ...
              >
                <img
                  src={
                    process.env.BASE_URL + paymentInfo?.data?.flutterwave?.logo
                  }
                  alt=""
                  className="w-full h-full object-contain"
                />
            ...
            {Number(paymentInfo?.data?.bankPayment?.status) === 1 && (
              <button
                onClick={() => {
                  setBankPay(true);
              ...
              >
                <img
                  src={
                    process.env.BASE_URL + paymentInfo?.data?.bankPayment?.image
                  }
                  alt=""
                  className="w-full h-full object-contain"
                />
      ...
      {bankPay && (
        <BankPayment
          paymentInfo={paymentInfo?.data?.bankPayment?.account_info}
          submitAction={(tnxId) => {
            setBankPay(false);
